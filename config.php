<?php  if ( ! defined('ONPATH')) exit('No direct script access allowed'); //Mencegah akses langsung ke class	
	...
	//Base URL
	$config['main']['url'] = "http://".$_SERVER['HTTP_HOST']."/surat-main/public/";
	$config['base']['url'] = "http://".$_SERVER['HTTP_HOST']."/surat-main/public/";
	$config['file']['url']	= "http://".$_SERVER['HTTP_HOST']."/surat-main/public/upload/";
